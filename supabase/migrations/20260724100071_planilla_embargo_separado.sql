-- =============================================================================
-- Vuelve al modelo donde "rebajos" (incapacidad/ausencias) y "embargo" son
-- montos INDEPENDIENTES (la UI mueve el monto de rebajos a embargo sola). El
-- embargo NO baja el salario; se acredita a "embargos por pagar".
--   Salario devengado (gasto) = base − rebajos
...
do $$ begin raise notice 'planilla: rebajos y embargo independientes (la UI mueve el monto).'; end $$;
