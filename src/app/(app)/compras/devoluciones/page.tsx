  ...
  return (
    <div>
      ...
      <div className="mt-1 mb-4 flex items-center justify-between">
        <div>
          <h1 className="text-lg font-semibold text-neutral-900">Devoluciones de compra</h1>
          <p className="text-sm text-neutral-500">
            Devolver mercadería al proveedor: baja inventario, revierte IVA y baja la CxP.
          </p>
        </div>
        <Link
          href="/compras/devoluciones/nueva"
            ...
            {devoluciones.map((d) => (
              <tr key={d.id}>
                ...
                <td className="px-4 py-3 text-right">
                  <Link
                    href={`/compras/devoluciones/${d.id}`}
